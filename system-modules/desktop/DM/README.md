...
The `displayManager` option defaults to `none`. Select `greetd-tuigreet` to
enable the implementation documented on the [greetd-tuigreet page](greetd-tuigreet.md).
